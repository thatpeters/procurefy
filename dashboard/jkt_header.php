...
function getAddress($RG_Lat, $RG_Lon)
{
    ...
    // 	return $RG_array['address']['county'];
    // } elseif (!empty($RG_array['address']['region'])) {
    // 	return $RG_array['address']['region'];
    // }elseif (!empty($RG_array['address']['district'])) {
    // 	return $RG_array['address']['district'];
    ...
    <section class="body">
        ...
        <header class="header">
            <div class="logo-container">
                <a href="." class="logo">
                    <img src="../assets/images/PWA.png" height="35" alt="ERROR" />
                </a>
        ...
        <div class="inner-wrapper">
                            ...
                            <ul class="nav nav-main">
                                ...
                                <li class="nav-parent nav-active">
                                    <a>
                                        ...
                                        <span>PSSF's Case</span>
                                    </a>
                                    <ul class="nav nav-children">
                                        <li>
                                            <a href="pbt_my_case.php">
                                                All
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_my_case.php?category=Waiting">
                                                Waiting
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_my_case.php?category=Pending">
                                                Pending
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_my_case.php?category=Acknowledged">
                                                Acknowledged
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_my_case.php?category=Closed">
                                                Closed
                                            </a>
                                        </li>
                                ...
                                <li class="nav-parent nav-active">
                                    ...
                                    <ul class="nav nav-children">
                                        <li>
                                            <a href="pbt_summary_map.php">
                                                All
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_summary_map.php?category=Pending">
                                                Pending
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_summary_map.php?category=Acknowledged">
                                                Acknowledged
                                            </a>
                                        </li>
                                        <li>
                                            <a href="pbt_summary_map.php?category=Closed">
                                                Closed
                                            </a>
                                        </li>
            ...
            <section role="main" class="content-body">
                <header class="page-header">
                    <h2>Public Facility Feedback System (<?php echo $_SESSION['jktid']; ?>)</h2>
